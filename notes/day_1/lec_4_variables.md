...
3.var : The value of a variable declared with var can also be changed later in the code.We dont use var nowadays, as they dont have scope'{}'(curly braces is the scope).
